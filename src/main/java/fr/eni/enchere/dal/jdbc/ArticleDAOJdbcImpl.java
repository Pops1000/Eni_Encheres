...
public class ArticleDAOJdbcImpl implements ArticleDAO {
	...
	private static final String SELECT_ALL_ARTICLES_WITH_USERINFO = "SELECT a.no_article,a.nom_article, "
			...
			+ " a.prix_vente, a.no_utilisateur, a.no_categorie, u.nom, u.prenom, u.rue, u.code_postal, u.ville FROM articles_vendus a "
	...
	public void createArticle(Article article) {
		...
		try (Connection con = ConnectionProvider.getConnection();
			...
			// récuperation du no_article pour futur ajout image
//			if (nb > 0) {
