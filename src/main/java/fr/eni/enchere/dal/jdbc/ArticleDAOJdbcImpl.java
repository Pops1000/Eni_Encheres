...
public class ArticleDAOJdbcImpl implements ArticleDAO {
	...
	private static final String SELECT_ARTICLE = "SELECT no_article,nom_article,description,date_debut_encheres,date_fin_encheres,prix_initial,prix_vente,no_utilisateur,no_categorie FROM articles_vendus;";
	private static final String SELECT_ARTICLE_AND_USER="SELECT a.no_article,a.nom_article, a.description, a.date_debut_encheres, a.date_fin_encheres, a.prix_initial, a.prix_vente, u.nom, u.prenom FROM articles_vendus a INNER JOIN utilisateurs u ON a.no_utilisateur = u.no_utilisateur;";
	...
	public List<Article> getAllArticles() {
		...
		try (Connection connection = ConnectionProvider.getConnection();
			...
			while (resultSet.next()) {
				...
				article.setDebut_enchere(resultSet.getString("debut_enchere"));
				article.setFin_enchere(resultSet.getString("fin_enchere"));
