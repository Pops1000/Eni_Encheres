		...
		<div class="row justify-content-center">
			<div class="col-md-4">
				...
				<form action="ServletCreateArticle" method="POST"
					...
					<label for="nom">Nom de l'article :</label><br> <input
						type="text" class="form-control" id="nom" name="nom" required><br>

					<label for="description">Description :</label><br>
					<textarea class="form-control" id="description" name="description"
						rows="4" cols="50" required></textarea>
					<br> <label for="debutEnchere">Date de début
						d'enchères :</label><br> <input type="date" class="form-control"
						id="debutEnchere" name="debutEnchere" required
						value="<%=LocalDate.now().toString()%>"><br> <label
						for="finEnchere">Date de fin d'enchères :</label><br> <input
						type="date" class="form-control" id="finEnchere" name="finEnchere"
						required value="<%=LocalDate.now().toString()%>"><br>

					<label for="prixInitial">Prix initial:</label><br> <input
						type="number" class="form-control" id="prixInitial"
						name="prixInitial"><br> <label for="categorie">Sélectionnez
						une catégorie :</label> <select class="form-control" id="categorie"
						name="noCategorie">
